...
function Audi({Auto}) {
  ...
  return (
    ...
    <div className="font-bold text-3xl text-gray-800  text-center">
      ...
      <img className="w-[111%]  max-w-none h-auto" src={Auto.kepek} alt="" />
    </div>
...
<button className="bg-transparent  hover:bg-red-600 text-red-600 font-semibold hover:text-white py-2 px-4 border-2 border-red-600 hover:border-transparent rounded" onClick={toggleReadMoreLess}>
